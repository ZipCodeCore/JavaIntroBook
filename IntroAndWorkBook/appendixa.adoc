...
[source]
----
var numList = List.of(1,2,3,4,5,6,7,8);
var evenNumbers = numList.stream()
...
[source]
----
var DISCOUNT_MULTIPLIER = Map.of(
  "TWENTYOFF", 0.80,
  "QUARTEROFF", 0.75,
  "HALFOFF", 0.50
);
...
static double discount(double amount, String code) {
  return amount * DISCOUNT_MULTIPLIER.getOrDefault(code, 1.0);
}
----

...
They're like functions in other languages, 
...
(Well, you should not be able take more money from an account than there is in the account!)

And sometimes, you'll hear that kind of programming referred to as _business rules_.
It's the kind of flexibility that programmers use to make the software do what it needs to do.
...
And consider, this a class like this you could make as many customer accounts as you might need.
Each one will have different values, assigned to different customers, keeping all the data correct.

...
These kinds of _computations_ rely on the fact that the computer won't do the wrong thing if its program is carefully crafted.

Given a simple math equation like:
**Problem: Solve for a**

a = 3b - 6 and if b equals 3, then a equals ?

In math class, your teacher would have said "How do we solve for a?" The best way to solve for `a = 3b - 6`
is to
...
**Exercise: Solve the equation with Java**
...
**Exercise: Calculate Area of a Triangle in Java**
...
**Exercise: Calculate the area of a circle whose radius is 7.7**

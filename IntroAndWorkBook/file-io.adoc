...
Create a program that reads a text file and writes an exact copy to a new file:
...
**Exercise 3: Simple Data File**
Read a file with names and ages, then create a report:

...
jshell> List<String> animals = new ArrayList<>(List.of("cat", "dog", "bird", "fish"));
...
jshell> List<String> names = new ArrayList<>(List.of("Charlie", "Alice", "Bob", "Diana"));
...
jshell> // Frequency counting
   ...> List<String> letters = List.of("a", "b", "a", "c", "b", "a");
letters ==> [a, b, a, c, b, a]

...
on how to install what you need.) --- (I'll wait. Go ahead, come back here when it's installed.)__
...
Create variables for your favorite food and hobby, then print them:

...
Note on exercises: So yeah, I want you to learn Java. And you claim you want to learn Java.
...
you know how to type? You'll go far in this gig!!)) Yeah, so here's the deal.

You should NOT copypasta these exercises into jshell. You should t-y-p-e them. Yes, that's right,
t-y-p-e them in with your fingers. You will practice what code looks like and how it goes
together if you do enough of it.
And that word, "copypasta", well look it up.  

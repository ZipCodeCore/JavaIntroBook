...
Java has a bunch different types of numbers.
...
we will use **double** as the kind of number we use when we need a number that might not 
be a _whole number_, but rather _real numbers_.

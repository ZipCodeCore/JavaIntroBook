...
When you see full programs with `public class Main`, you can extract just the statements inside the main method and run them directly in jshell. So instead of the full program above, you can just type:
```
jshell> double milesPerHour = 55.0;
jshell> System.out.println("Car's Speed: " + milesPerHour);
```

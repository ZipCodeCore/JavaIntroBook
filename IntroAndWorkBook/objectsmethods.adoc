...
class Weapons {
    ...
    public Weapons(String sword, String bow, int arrows) {
        this.sword = sword;
        this.bow = bow;
        this.arrows = arrows;
    }
...
class Player {
    ...
    public Player(String name, String species, String superPower, int lives, Weapons weapons) {
        this.name = name;
...
Player player1 = new Player("Rocco", "warrior", "flight", 4, 
    new Weapons("Excalibur", "Legolas", 12));
----
...
// player1.nickname  // would cause compilation error - field doesn't exist

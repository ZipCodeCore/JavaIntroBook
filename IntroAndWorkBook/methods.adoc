...
Some methods just perform actions without giving anything back. 
These are called "void" methods because they return nothing - 
they just do something like printing text or changing data.
...
With a single parameter, your method can work with different values each time:
...
When your method needs more than one piece of information, 
...
Methods can accept different types of parameters in the same method.
This lets you work with text, numbers, and other data types together:
...
Programming is all about moving data around and transforming it.
Methods do calculations and then need a way to give back their results.
...
Methods often need to make decisions based on the data they receive.
This is where if statements become very useful:
...
Validation methods check if something is true or false.
They're very useful for making decisions in your programs:
...
Utility methods are helpful functions you can reuse throughout your program.
They handle common tasks like calculations or conversions:

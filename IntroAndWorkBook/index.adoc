...
the programming language we have been teaching at Zip Code Wilmington for more than 8 years. 
...
Java is a fairly easy programming language to learn, and we're going to use it in 
this book to describe the basic fundamentals of coding. 
Its form is modern and it is widely used. 
...
methods and concepts; but make no mistake - Java is world-class language capable of amazing things.

And companies are still paying well for people who know how to use a decades-old 

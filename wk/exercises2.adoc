...
Practice reading user input with Scanner. Try these exercises:
...
Write a function that takes a double price and returns the dollars (as an int) and cents (as an int) separately.

----
public static void separatePrice(double price) {

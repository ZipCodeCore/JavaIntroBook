...
You may be aware that Zip Code doesn't focus on JavaScript _per se_, we don't focus on JavaScript in any of our current courses and that can leave you wondering why the first book we wrote was all about JavaScript. Well...
...
JavaScript also has the advantage that one can learn to use it without a lot of setup on a computer. In fact, we recommend the use of a "REPL" for the running of the JavaScript examples you'll find in this book. The REPL at https://code.zipcode.rocks is a simple webpage where you can edit JavaScript scripts, click a button, and run them. You can run almost every code snippet in the book and _see_ what the code does.

==== Focuses on coding

Finally, because in this book all we aim to teach you is "programming in the small", JavaScript is great for that. Many of the examples here are significantly less that 20 lines in length. We want you to get better at looking at small blocks of code to see how they work. These smaller examples and concepts are core building blocks (and patterns) as you become proficient in coding. 
...
And, of course, this book exists because we've chosen JavaScript as the language we use to see if you can learn enough
coding to solve some some beginner problems on the ZipCode admissions assessment.
After some modest study, a successful aspiring Zipcoder should be able to apply what they have learned to produce code
which runs and produces the right answers. 
If you like what you have to do to prep for the assessment, if you find it interesting and challenging and find the activity
empowering, you may have what it takes to enjoy a career using software to solve problems.
...
Coding, like writing, isn't something you can do when all your other chores, obligations, and entertainments are done. If you're serious about learning coding, you must make time for coding. If you're serious about coding, you'll find a way to do it.
...
The only way you're going to learn to code is by doing it, by typing in code. Trying to solve a problem. Making mistakes, fixing them, learning from what worked and what didn't at the keyboard. 
...
And you will think: *Nope. It wasn't luck.* You'll know that truly. You got there by preparing yourself to get there, and by working to get there, working _very hard_ to get there. Ain't no luck involved, just hard work. You make your own luck by working hard.
...
Working on code every day makes you a coder. And coding everyday will help with your ability to eventually score high enough on the Zip Code admissions assessment that you get asked to a group interview, and potentially, final interviews. And then, well, then you get to learn Java or Python and work yourself to exhaustion doing so. Lots and lots more work. 

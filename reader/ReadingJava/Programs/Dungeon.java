...
//
//
// The code is not well formatted, and it is hard to read.
// The code is not well commented, and it is hard to understand.
// The code is not well organized, and it is hard to maintain.
// The code is not well named, and it is hard to understand.
// The code is not well tested, and it is hard to trust.
// The code is not well designed, and it is hard to change.
